...
public:
    ...
    virtual bool is_color(std::string_view control, std::string_view value) const = 0;
    virtual void set_color(std::string_view control, std::string_view value, color color_) = 0;
    [[nodiscard]] virtual color get_color(std::string_view control, std::string_view value) const = 0;

    virtual void set_dimension(std::string_view control, std::string_view value, int32_t dimension) = 0;
    [[nodiscard]] virtual int32_t get_dimension(std::string_view control, std::string_view value) const = 0;

    virtual void set_string(std::string_view control, std::string_view value, std::string_view str) = 0;
    [[nodiscard]] virtual const std::string &get_string(std::string_view control, std::string_view value) const = 0;

    virtual void set_font(std::string_view control, std::string_view value, const font &font_) = 0;
    [[nodiscard]] virtual font get_font(std::string_view control, std::string_view value) const = 0;

    virtual void set_image(std::string_view name, const std::vector<uint8_t> &data) = 0;
    [[nodiscard]] virtual const std::vector<uint8_t> &get_image(std::string_view name) = 0;
