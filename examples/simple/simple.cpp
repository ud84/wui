...
struct PluggedWindow : public std::enable_shared_from_this<PluggedWindow>
{
    ...
    PluggedWindow(std::shared_ptr<wui::window> &parentWindow_)
        ...
        list(new wui::list()),
		button1(new wui::button("Button 1", [this]() { wui::show_message("Lorem Ipsum is simply dummy text of the printing and typesetting industry.\nLorem Ipsum has been the industry's\nstandard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", "hello world",
			wui::message_icon::information, wui::message_button::ok, window, false); }, wui::button_view::image, IMG_ACCOUNT, 16)),
