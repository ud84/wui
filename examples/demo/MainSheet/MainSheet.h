...
private:
    ...
    std::shared_ptr<wui::scroll> vertScroll = std::make_shared<wui::scroll>(100000, 0, 5.0, wui::orientation::vertical, [this](wui::scroll_state, int32_t v) { welcomeText->set_text(std::to_string(v)); });
