...
Работы начались в декабре 2021 года. Наш основной проект (видеомессенджер) использовал WTL для Windows и GTKmm для Linux. Поддержки Mac не было. Таскать за собой две идентичные кодовые базы, которые должны делать всё строго одинаково, было огромной проблемой. Конечно, это никогда не работало как надо. Мысль о создании ещё одного нативного клиента для Mac вызывала нервный тик...

На разумный вопрос — почему сразу не сделали на Qt, можем ответить только так: это связано, скажем так, с гастрономическими предпочтениями и, отчасти, с любовью к монолитным exe. Да и в начале нам не нужно было ничего, кроме Windows.
...
Должны сказать, что мы активно используем boost и любим его настолько, насколько можно любить всей душой...
...
wxWidgets неплох, но нам хотелось собственной отрисовки, без рамок для кнопок, полей ввода и списков, лицензии типа boost/BSD, максимально лаконичный, и в идеале работающий от Windows XP / CentOS 6 на стандартном GDI / X11 до Vulkan на современных машинах.
