...
В WASM INI-файлы живут в памяти и сбрасываются при перезагрузке. На macOS выбирайте доступное для записи место, например Application Support; bundle предназначен для ресурсов, а не настроек.
