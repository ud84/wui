...
Числовые режимы ограничивают допустимые символы; встроенного спиннера и изменения числа колесом нет. Однострочные поля не прокручиваются по вертикали. В режиме read-only доступны выделение и копирование, без мигающего курсора ввода.
